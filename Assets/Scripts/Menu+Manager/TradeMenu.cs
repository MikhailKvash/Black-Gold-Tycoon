...
public class TradeMenu : MonoBehaviour
{
    ...
    [SerializeField] private float oilSliderAmount;
    ...
    public float OilSliderAmount
    {
        get => oilSliderAmount;
        set => oilSliderAmount = value;
    }
    ...
    private void Update()
    {
        ...
        if (oilSliderAmount <= 0)
        {
            _sendShipButtonOff = true;
        }
        
        if (oilSliderAmount > 0 && !_sentForCargo)
        {
        ...
        oilDisplay.GetComponent<TextMeshProUGUI>().text = oilSliderAmount + "";
